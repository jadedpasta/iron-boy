...
const OP_TABLE: [InstructionEntry; 0x100] = [
    ...
    new(Ld(Var8::Reg(Reg8::C), Operand8::new_reg(Reg8::D)), 1, 1), // 0x4a
    ...
    new(Ld(Var8::Reg(Reg8::D), Operand8::new_reg(Reg8::D)), 1, 1), // 0x52
    ...
    new(Ld(Var8::Reg(Reg8::E), Operand8::new_reg(Reg8::D)), 1, 1), // 0x5a
    ...
    new(Ld(Var8::Reg(Reg8::H), Operand8::new_reg(Reg8::D)), 1, 1), // 0x62
    ...
    new(Ld(Var8::Reg(Reg8::L), Operand8::new_reg(Reg8::D)), 1, 1), // 0x6a
